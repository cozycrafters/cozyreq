...
class TestRunCommand:
    ...
    def test_run_command_with_yaml_spec(self):
    ...
    def test_run_command_network_error(self):
    ...
    def test_run_command_empty_spec(self):
    ...
    def test_run_command_complex_spec(self):
